...
<header>
    <div class="container">
        <nav class="navbar navbar-expand-lg">
            ...
            <button class="navbar-toggler" type="button" data-bs-toggle="offcanvas" data-bs-target="#listaEnlaces"
                aria-controls="listaEnlaces">
            ...
            <div class="offcanvas offcanvas-end" data-bs-backdrop="static" id="listaEnlaces">
                ...
                <div class="offcanvas-body justify-content-center">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item px-2"><a class="nav-link" href="finishedTasks.php">Tareas Finalizadas</a>
                        </li>
                        <?php
                        
                        if (isset($_SESSION['userid'])) {
                            echo '<li class="nav-item px-2"><a class="nav-link" href="myTasks.php">Mis Tareas</a></li>';
                             // Verifica si el usuario es administrador para mostrar el menú de administración
                        if (isset($_SESSION['userid']) && isset($_SESSION['is_admin']) && $_SESSION['is_admin']) {
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item disabled" href="#">Gestionar Tareas</a></li>
                                    <li><a class="dropdown-item disabled" href="#">Administrar Usuarios</a></li>
                                </ul>
                            </li>
                            ';
                        }                            

        ...
        <nav class="navbar navbar-expand-lg">
            ...
            <div class="offcanvas offcanvas-end" data-bs-backdrop="static" id="listaEnlaces">
                ...
                <div class="offcanvas-body justify-content-center">
                    <ul class="navbar-nav">
                        <li class="nav-item px-2"><a class="nav-link" href="">Tareas</a></li>
                        <li class="nav-item px-2"><a class="nav-link" href="">Tareas asignadas</a></li>
                        <li class="nav-item px-2"><a class="nav-link" href="">Tareas Finalizadas</a></li>
                        <?php
                        if (isset($_SESSION['userid'])) {
                            echo '<li class="nav-item px-2"><a class="nav-link" href="">Mis Tareas</a></li>';
                            echo '
